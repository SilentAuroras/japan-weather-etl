...
# Pull earthquake data from the Japan Meteorological Agency (JMA)
def get_earthquake_events():

    # Request the list of recent quake events
    df_recent_events = pd.DataFrame()

    # List of recent JMA quakes - https://www.jma.go.jp/bosai/quake/data/list.json
    ...
    # Response error
        ...
        logging.error(f"Unable to download recent quake data: {response.status_code}")
